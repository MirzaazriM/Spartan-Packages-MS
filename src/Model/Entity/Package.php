...
class Package implements HasId
{
     ...
     * @return mixed
     */
    public function getRecepiesIds()
    {
        return $this->recepiesIds;
    }

    /**
     * @param mixed $recepiesIds
     */
    public function setRecepiesIds($recepiesIds): void
    {
        $this->recepiesIds = $recepiesIds;
    }
